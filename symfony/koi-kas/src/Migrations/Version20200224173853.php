 ...
 */
final class Version20200224173853 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE karper (id INT AUTO_INCREMENT NOT NULL, naam VARCHAR(255) NOT NULL, soort VARCHAR(255) NOT NULL, kweker VARCHAR(255) NOT NULL, leeftijd INT NOT NULL, maat INT NOT NULL, prijs NUMERIC(10, 2) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
