 ...
 */
final class Version20200225124053 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE kweker ADD zoek_naam VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE leeftijd ADD zoek_naam VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE kweker DROP zoek_naam');
        $this->addSql('ALTER TABLE leeftijd DROP zoek_naam');
        $this->addSql('ALTER TABLE maat CHANGE zoek_naam zoek_naam VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE soort CHANGE zoek_naam zoek_naam VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
